...
\newcommand{\professor}{%
    ...
    57,58,60,61,64,65,67,69,70,71,72,73,74,75,76,78,79,80%
}
...
\foreach \i in {1,...,\nlinhas}{%
    \foreach \j in {1,...,\numexpr \ncolunas - 1\relax}{%
        \gappto\mymatrixcontent{\dma}
        \xappto\mymatrixcontent{{\i}{\j}}
        \gappto\mymatrixcontent{&}
    }%
    \gappto\mymatrixcontent{\dma}
    \xappto\mymatrixcontent{{\i}{\ncolunas}}
    \gappto\mymatrixcontent{\\ \hline}
}%

...
\begin{frame}{Computadores \textit{modernos}}
    \begin{itemize}
        ...
        \item Qual o maior número que pode ser
            armazenado em um odômetro binário com \SI{4}{bytes}? 
    \end{itemize}

    \centering
    \includegraphics[height=0.54\textheight]{images/Captura de tela de 2023-03-26 23-58-54.png}
\end{frame}

\begin{frame}
    \begin{center}
        \includegraphics[height=0.75\textheight]{images/Captura de tela de 2023-03-27 00-22-46.png}
    \end{center}
\end{frame}
...
\begin{frame}[c]
    \frametitle{Conversão de decimal para binário}
    \begin{center}
        \begin{tikzpicture}

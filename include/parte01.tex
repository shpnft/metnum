...
\begin{frame}{Código em C: cabeçalho, \textit{main}, declaração de variáveis}
    \lstinputlisting[language=C, firstline=1, lastline=12]{src/ieee-754.c}
\end{frame}

\begin{frame}{Código em Python: cabeçalho}
    \lstinputlisting[language=Python, firstline=1, lastline=2]{src/ieee-754.py}
\end{frame}

\begin{frame}{Código em C: leitura do número, determinação do sinal e expoente}
    \lstinputlisting[language=C, firstline=14, lastline=22]{src/ieee-754.c}
\end{frame}

\begin{frame}{Código em Python: leitura do número, determinação do sinal e expoente}
    \lstinputlisting[language=Python, firstline=4, lastline=12]{src/ieee-754.py}
\end{frame}

\begin{frame}{Código em C: determinação da mantissa com 24 bits}
    \lstinputlisting[language=C, firstline=24, lastline=38]{src/ieee-754.c}
\end{frame}

\begin{frame}{Código em Python: determinação da mantissa com 24 bits}
    \lstinputlisting[language=Python, firstline=14, lastline=26]{src/ieee-754.py}
\end{frame}

\begin{frame}{Código em C: \textit{arredondamento} da mantissa para 23 bits}
    \lstinputlisting[language=C, firstline=39, lastline=52]{src/ieee-754.c}
\end{frame}

\begin{frame}{Código em Python: \textit{arredondamento} da mantissa para 23 bits}
    \lstinputlisting[language=Python, firstline=28, lastline=40]{src/ieee-754.py}
\end{frame}

\begin{frame}{Código em C: adaptação/correção do expoente, saída de dados e finalização}
    \lstinputlisting[language=C, firstline=53, lastline=63]{src/ieee-754.c}
\end{frame}

\begin{frame}{Código em Python: adaptação/correção do expoente, saída de dados e finalização}
    \lstinputlisting[language=Python, firstline=42, lastline=48]{src/ieee-754.py}
\end{frame}

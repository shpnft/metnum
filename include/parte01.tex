...
\begin{frame}{Fim do assunto para a primeira avaliação}
    \begin{itemize}
        \item Assunto da prova (50\% da \(N_1\)): método da bissecção, método de Newton-Raphson,
            estimativa de erro relativo
        \item Assunto do trabalho (50\% da \(N_1\)): sistemas de numeração
    \end{itemize}
\end{frame}
